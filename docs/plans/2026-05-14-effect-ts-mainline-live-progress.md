...
3. Effect-created relays now receive project/instance read-model suppliers, instance mutator callbacks, scan/update replay, and push delivery; mutating project callbacks and in-flight creation cancellation still need parity before daemon cutover.
