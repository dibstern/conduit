...
3. Effect-created relays now receive project/instance read-model suppliers, project/instance mutator callbacks, scan/update replay, and push delivery; in-flight creation cancellation still needs parity before daemon cutover.
