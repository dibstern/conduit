...
1. The legacy `startDaemonProcess` bridge still exists for non-CLI parity harnesses until branch-local smoke parity is proven against the Effect-owned graph.
