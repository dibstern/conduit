...
1. No `startDaemonProcess` production bridge blocker remains. Continue with final app-internal `Effect.runPromise` / `Effect.runSync` grep cleanup and reclassification.
