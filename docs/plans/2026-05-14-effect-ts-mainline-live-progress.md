...
3. Effect-created relays now receive project/instance read-model suppliers, but mutating project/instance callbacks, scan/update replay, push delivery, and in-flight creation cancellation still need parity before daemon cutover.
