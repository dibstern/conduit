...
<div id="agent-selector" class:hidden={shouldHide}>
	<button
		bind:this={triggerEl}
		class="inline-flex items-center gap-[2px] h-9 px-2 border-none bg-transparent text-text-muted font-sans text-xs font-medium cursor-pointer whitespace-nowrap transition-[background,color] duration-150 rounded-[10px] max-w-[160px] hover:bg-bg-alt hover:text-text-secondary"
		title="Switch agent"
