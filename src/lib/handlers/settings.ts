...
export const handleGetCommandsEffect = (
	clientId: string,
	_payload: PayloadMap["get_commands"],
) =>
	Effect.gen(function* () {
...
export const handleGetProjectsEffect = (
	clientId: string,
	_payload: PayloadMap["get_projects"],
) =>
	Effect.gen(function* () {
...
export const handleAddProjectEffect = (
	clientId: string,
	payload: PayloadMap["add_project"],
) =>
	Effect.gen(function* () {
...
export const handleGetTodoEffect = (
	clientId: string,
	_payload: PayloadMap["get_todo"],
) =>
	Effect.gen(function* () {
...
export const handleRemoveProjectEffect = (
	clientId: string,
	payload: PayloadMap["remove_project"],
) =>
	Effect.gen(function* () {
...
export const handleRenameProjectEffect = (
	clientId: string,
	payload: PayloadMap["rename_project"],
) =>
	Effect.gen(function* () {
...
export const handleListDirectoriesEffect = (
	clientId: string,
	payload: PayloadMap["list_directories"],
) =>
	Effect.gen(function* () {
