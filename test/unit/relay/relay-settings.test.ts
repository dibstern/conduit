...
describe("relay-settings", () => {
	...
	describe("Claude settings overrides persistence", () => {
		it("round-trips and replaces the open JSON-valued record", () => {
			saveRelaySettings(
				{
					claudeSettings: {
			...
			expect(loadRelaySettings(tempDir).claudeSettings).toEqual({
